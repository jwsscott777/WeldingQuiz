      ...
      if (newQuestText.value !== "") {
        if (optionsArr.length > 1) {
          if (isChecked) {
            ...
            alert("You need to check the correct answer");
            return false;
          }
        } else {
...
var UIController = (function () {
  ...
  return {
    ...
    newDesign: function (ansResult, selectedAnswer) {
      ...
      twoOptions = {
        instAnswerText: ["This is wrong", "This is correct"],
      ...
      if (
        ...
        if (
          ...
          if (storageQuestList.getQuestionCollection().length > 0) {
            ...
            alert("Questions in progress, wait for admin");
          }
        } else {
          domItems.landPageSection.style.display = "none";
...
var controller = (function (quizCtrl, UICtrl) {
  ...
  selectedDomItems.questInsertBtn.addEventListener("click", function () {
    ...
    var checkBoolean = quizCtrl.addQuestionLocalStorage(
  ...
  selectedDomItems.quizOptionsWrapper.addEventListener("click", function (e) {
    var updatedOptionsDiv = selectedDomItems.quizOptionsWrapper.querySelectorAll(
      "div"
    );
